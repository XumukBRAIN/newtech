package ru.kudryashov.newtech.exceptions.handlers;
...
public class AppErrorWebExceptionHandler extends AbstractErrorWebExceptionHandler {
    ...
    public AppErrorWebExceptionHandler(ErrorAttributes errorAttributes, ServerCodecConfigurer serverCodecConfigurer, ApplicationContext applicationContext) {
